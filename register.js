...
function create()
{
    ...
    class register
    {
        ...
        check()
        {
            ...
            if (!(8 <= this.number.length <= 30))
            {
                numbalert = " Phonenumber must have 8 to 30 digits ";
                alert(numbalert);
                success = 0;
            }
            // var re = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
            ...
            {
                passalert = " Password must contain an uppercase";
                alert(passalert);
                success = 0;
            ...
            {
                passalert = " Invalid password confirmation";
                alert(passalert);
                success = 0;
            }
            if (success == 1)
